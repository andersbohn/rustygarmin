        ...
        Ok(jsonStr) => {
            ...
            match res {
                Ok(json) => {
                    ...
                    let string = match &json[1] {
                        Activity::Hiking { id, name,distance,duration } => "hiky",
                        Activity::Cycling { id, name,distance,duration } => "cycling",
                        Activity::Bouldering { id, name,duration } => "bouldering",
                        _ => "others"
                    };
